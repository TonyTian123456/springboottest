...
import com.example.config.datasource.prop.BaiduParamsProperties;
...
public class HttpClientUtil {
	...
	private static String ak="mkW9Rk57o8w7Htp8M06VXToVvGADGqsN";
	private static String sk="ZX2nbWb2bWk4zonjB37QETqZc6Smz3K5";
   /* @Autowired
    private static BaiduParamsProperties baiduParamsProperties;*/
	/**
	 * @Title: doGet
	 * @Description: get方式
	 * @author Mundo
	...
	public static String sendJsonStr(String url, String params) {
		...
		try {
			...
			httpPost.addHeader("requestTime", String.valueOf(requestTime));
			httpPost.addHeader("signature",getSignature(params,requestTime,requestId));
	...
	public  static String getSignature(String paramJson,long requestTime,String requestId) throws UnsupportedEncodingException {

		String md5 = MD5Util.getMD5(ak + sk +requestId+ requestTime + paramJson);
		return md5;
	}
