 ...
 */
@Configuration
@MapperScan(basePackages = "com.example.mapper.database1", sqlSessionTemplateRef = "userSqlSessionTemplateUser")
public class DataBase1SourceConfigration {
    ...
    public SqlSessionFactory sqlSessionFactoryBlueWhale(@Qualifier("userDataSource") DataSource dataSource)
        ...
        sessionFactory.setTypeAliasesPackage("com.example.domain.database1");
        // Mybatis Config
        ...
        String resouces[] = {"classpath*:/mybatis/database1/*.xml"};
